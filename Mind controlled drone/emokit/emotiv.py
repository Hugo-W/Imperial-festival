...
class EmotivPacket(object):
    ...
    def __init__(self, data, sensors, model):
        ...
        self.gyro_x = ord(data[29]) - 106 +9
        self.gyro_y = ord(data[30]) - 105 -3 #HUGO: I added "+9" and "-3"
...
class Emotiv(object):
    ...
    def setup_crypto(self, sn):
        ...
        print 'Display ON', self.display_output
        print 'Research headset', self.is_research
        k = ['\0'] * 16
        k[0] = sn[-1]
        k[1] = '\0'
        k[2] = sn[-2]
